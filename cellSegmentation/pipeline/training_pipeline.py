...
class TrainPipeline:
    ...
    def run_pipeline(self) -> None:
        try:
            ...
            # Uncomment and use this block when you implement data validation
            ...
            # Placeholder until data validation is implemented
            logging.warning("Skipping model training because data validation is not implemented.")
